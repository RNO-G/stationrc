...
class ControllerBoard(object):
    ...
    def __init__(self, uart_device, uart_baudrate=115200, background_sleep=5):
        ...
        self.uart = serial.Serial(port=uart_device, baudrate=uart_baudrate, timeout=0.1) # TODO: optimize timeout for commands to return a result
        
        self.thr_bkg = threading.Thread(target=ControllerBoard.receive_background_data, args=[self])
        self.thr_bkg.start()
